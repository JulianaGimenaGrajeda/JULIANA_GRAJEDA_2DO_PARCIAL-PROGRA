...
logo = configurar_imagen(RUTA_IMAGEN+"logou.png",(320,320))
pygame.display.set_icon(logo)

#IMÁGENES
fondo = configurar_imagen(RUTA_IMAGEN+"fondou.png",(2000,800))
fondo_final = configurar_imagen(RUTA_IMAGEN+"fondo.png",(1250,800))
...
#SONIDOS
sonido_error = pygame.mixer.Sound(RUTA_SONIDO+"error.wav")
...
#PERSONAJE
personaje = configurar_imagen(RUTA_IMAGEN + "stolistis.png",(150, 150))
