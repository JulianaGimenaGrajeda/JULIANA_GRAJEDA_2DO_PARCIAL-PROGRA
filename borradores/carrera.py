...
posicion_inicial = (145,344)
posicion_inicial = list(posicion_inicial)
rect_personaje.topleft = posicion_inicial
...
while correr:
    ...
    if bandera_correcta:
        ...
        if bandera_avanzar:
            ...
            if not (posicion_x + distancia > 1000):
                bandera_x = True
                bandera_y = False
            elif bandera_x and posicion_y < 500:
                distancia = 150
                posicion_y += distancia

                if posicion_y > 500 and not bandera_y:
                    posicion_y -= distancia
                    bandera_x = False
                    bandera_y = True
                ...
                print(bandera_x)
                print(bandera_y)
            elif not bandera_x and bandera_y:
                direccion = -1
                distancia =- 212
                bandera_y = False
                bandera_x = True
    ...
    if bandera_avanzar:
        if bandera_x:
            if direccion == 1 and rect_personaje.x < posicion_x:
                rect_personaje.x += velocidad
            elif direccion == -1 and rect_personaje.x > posicion_x:
                rect_personaje.x -= velocidad
        elif bandera_y:
            if rect_personaje.y < posicion_y:
